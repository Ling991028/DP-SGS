...
def create(seed,n_el=16, fd=None, fh=area_uniform, h0=0.1, p_fix=None, bbox=None):
    """
    ...
    # 1. build triangle
    p, t = distmesh.build(fd, fh, pfix=p_fix, h0=h0)
    ...
    perm = np.ones(t.shape[0], dtype=float)
